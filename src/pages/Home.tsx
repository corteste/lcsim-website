...
const topTeams = [
  { position: 1, team: "FC Dragonslayers", points: 25 },
  { position: 2, team: "Thunder United", points: 23 },
  { position: 3, team: "Phoenix Rising", points: 21 },
];

const stats = [
  { label: "Squadre Totali", value: "8", icon: Users, color: "text-blue-600" },
  { label: "Giornate Giocate", value: "10", icon: Target, color: "text-green-600" },
  { label: "Gol Totali", value: "142", icon: Award, color: "text-orange-600" },
