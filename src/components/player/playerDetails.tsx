          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <CardTitle className="flex items-center gap-2">
                <img src={getPlayerImage(currentPlayer.ID)} onError={(e) => e.currentTarget.src = "/images/players/MConti.png"} alt="Player" className="h-16 w-16 object-contain border rounded-full" />
